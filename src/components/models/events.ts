...
export const events: Event[] = [
  {
    ...
    instagramLink: "https://www.instagram.com/ligia.ufpe/p/DFa0C4vJL0r/",
    speakers: [
      {
  ...
  },
  {
    ...
    instagramLink: "https://www.instagram.com/ligia.ufpe/p/DKAUK3RO2Xf/",
    speakers: [
      {
        name: "Prof. George Cavalcanti",
        role: "Professor Titular e Coordenador de Pesquisa (CIn-UFPE)",
  ...
  },
  {
    ...
    instagramLink: "https://www.instagram.com/ligia.ufpe/p/DLiDPuJOZLk/",
    highlights: [
      "Imersão científica",
      "Clubes interativos",
